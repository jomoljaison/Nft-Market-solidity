...
contract NEXTAZY is ERC1155, Ownable {
  ...
  function mint(address _to, uint _id, uint _amount,string memory _uri) external  {
    ...
    function transferNft(
        ...
        require(
            balanceOf(owner, tokenid) >= 0,
            "user dont have nfts"
        );

       safeTransferFrom(owner, buyer, tokenid, qty, "");
    }
